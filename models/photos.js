...
module.exports = {
	...
	uploadFiles:(request,response,uploaddir,cb)=>{
	...
	uploadFiles2 :(request,response,uploaddir,callback)=>{
		fs.access(uploaddir,(error)=>{
			if(error)
			{
				response.redirect('/');
